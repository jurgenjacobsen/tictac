...
const TrainingAreas: React.FC<{ schedule?: Reservation[] }> = (props) => {
    ...
    return (
        <div className='ring-1 ring-neutral-300 p-4 rounded-lg cursor-default'>
            {/* Header */}
                    ...
                    <div key={area.id} className='ring-1 ring-neutral-300 rounded-lg overflow-hidden'>
                        ...
                        <div className='py-4 px-4 space-y-2'>
                            ...
                            {area.nextReservation ? (
                                <span className='rounded-md block w-full bg-neutral-300 px-2' title={`Next session by ${area.nextReservation.callsign}`}>
